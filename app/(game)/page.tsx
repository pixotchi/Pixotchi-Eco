  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="host-chrome-stable-surface host-chrome-solid-card host-chrome-stable-theme bg-card/90 backdrop-blur-sm overscroll-none">
          <header data-viewport-shell="header" className="host-chrome-stable-surface host-chrome-solid-card host-chrome-stable-theme bg-card/90 backdrop-blur-sm border-b border-border px-4 py-2 overscroll-none safe-area-top" role="banner" aria-label="Application header">
