...
export const KNOWLEDGE_TOPICS: Record<KnowledgeTopicId, KnowledgeTopicRecord> = {
  ...
  casino: {
    ...
    canRead: ['Casino built status.', 'Roulette and Blackjack gameplay configs.', 'Supported betting tokens.', 'Active game snapshots.', 'Current Blackjack action button availability.', 'Recent public casino activity when indexed.'],
