...
export const KNOWLEDGE_TOPICS: Record<KnowledgeTopicId, KnowledgeTopicRecord> = {
  ...
  notifications: {
    ...
    deferralText: 'Use the mini app/Base App notification opt-in flow and Status page if reminders are missing.',
    id: 'notifications',
  ...
  wallet_modes: {
    aliases: ['smart wallet', 'base account', 'base app', 'eoa', 'eth mode', 'sponsored', 'paymaster', 'wallet mode', 'atomic bundle', 'solana wallet'],
