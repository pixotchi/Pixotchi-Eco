...
export const KNOWLEDGE_TOPICS: Record<KnowledgeTopicId, KnowledgeTopicRecord> = {
  ...
  barracks_raids: {
    ...
    canRead: ['Owned lands.', 'Barracks built state.', 'Troop state exposed by land reads.', 'Eligible raid targets.', 'Read-only raid previews.', 'Time-ranged incoming/outgoing land raid activity.'],
    ...
    id: 'barracks_raids',
    liveDataSources: ['get_land_raid_targets', 'get_lands', 'get_combat_activity', 'get_wallet_game_activity', 'get_activity'],
  ...
  casino: {
    ...
    canRead: ['Casino built status.', 'Roulette and Blackjack configs.', 'Supported betting tokens.', 'Active game snapshots.', 'Recent public casino activity when indexed.'],
    ...
    id: 'casino',
    liveDataSources: ['get_casino_status', 'get_lands', 'get_wallet_game_activity', 'get_activity'],
  ...
  lands: {
    ...
    id: 'lands',
    liveDataSources: ['get_lands', 'get_land_production_audit', 'get_land_raid_targets', 'get_casino_status', 'get_marketplace_orders', 'get_wallet_game_assets', 'get_wallet_game_activity'],
  ...
  onboarding: {
    ...
    id: 'onboarding',
    liveDataSources: ['get_player_overview', 'get_daily_task_plan', 'get_game_prices', 'get_wallet_token_balances', 'get_game_action_guide'],
  ...
  swap: {
    ...
    id: 'swap',
    liveDataSources: ['get_swap_quote', 'get_wallet_token_balances', 'get_known_allowances', 'get_app_status'],
