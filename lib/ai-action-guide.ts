...
export const KNOWLEDGE_TOPICS: Record<KnowledgeTopicId, KnowledgeTopicRecord> = {
  ...
  rename_assets: {
    ...
    stalenessRules: ['Plant rename price is configurable; use live price/readiness when available and visible UI as final source.', 'Land rename is an owner-only sponsored/free UI action.', 'Plant names must be 2-10 UTF-8 bytes; land names must be 3-10 UTF-8 bytes. Emoji and accented letters can use multiple bytes.'],
    title: 'Rename Plants and Lands',
    userFlows: ['Open Farm.', 'Choose Plants or Lands.', 'Select an asset you own.', 'Press the visible edit/name button.', 'Enter a name within the byte counter limit.', 'For plants, review the live SEED cost or ETH-mode quote if shown.', 'For lands, use the owner-only sponsored rename action.', 'Confirm through the UI.'],
  ...
  notifications: {
    ...
    userFlows: ['Open the app in the supported mini app/Base App context.', 'Save/add the app or enable notifications when prompted.', 'Keep plants below the reminder threshold only if you want a care reminder.', 'Check Status if reminders stop arriving.'],
  ...
  support_links: {
    ...
    userFlows: ['Open About.', 'Choose Status, Tutorial, Feedback, Documentation, or community support if visible.', 'Use the Status link for outages and Feedback for reproducible bugs.'],
