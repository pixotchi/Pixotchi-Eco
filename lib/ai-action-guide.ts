...
export const KNOWLEDGE_TOPICS: Record<KnowledgeTopicId, KnowledgeTopicRecord> = {
  ...
  support_links: {
    ...
    deferralText: 'Use About for visible support actions; ask the team/community for unresolved gameplay or account-specific issues.',
    id: 'support_links',
    ...
    userFlows: ['Open About.', 'Choose Status, Game guide, Feedback, Docs, or a community link.', 'Use the Status link for outages and Feedback for reproducible bugs.'],
    where: 'About tab and public app routes',
  },
  support: {
    ...
    deferralText: 'Use About -> Feedback, Status, Docs, or the displayed community links for unresolved issues.',
    id: 'support',
    ...
    userFlows: ['Open About.', 'Use Feedback, Status, Game guide, or Docs.', 'Use the displayed community links for gameplay help; never post wallet secrets or private account details.'],
