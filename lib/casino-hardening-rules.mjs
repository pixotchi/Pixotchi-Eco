...
const redNumbers = new Set(RED_NUMBERS);
...
export function rouletteBetWins(betType, numbers, winningNumber) {
  ...
  if (betType === ROULETTE_BET_TYPE.RED) return redNumbers.has(winningNumber);
  if (betType === ROULETTE_BET_TYPE.BLACK) return !redNumbers.has(winningNumber);
