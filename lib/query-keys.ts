export const queryKeys = {
  ...
  questsByLand: (address: string | null | undefined, chainId: number, landId: bigint | null) =>
    ["questsByLand", address?.toLowerCase() ?? "anonymous", chainId, landId?.toString() ?? "none"] as const,
