...
export const LAND_CONTRACT_ADDRESS = CLIENT_ENV.LAND_CONTRACT_ADDRESS;
export const LEAF_CONTRACT_ADDRESS = CLIENT_ENV.LEAF_CONTRACT_ADDRESS;
export const STAKE_CONTRACT_ADDRESS = CLIENT_ENV.STAKE_CONTRACT_ADDRESS;
export const BATCH_ROUTER_ADDRESS = CLIENT_ENV.BATCH_ROUTER_ADDRESS ?? undefined;