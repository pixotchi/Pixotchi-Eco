...
export function showMiniAppRequiredToast(input?: {
  ...
  toast.custom(
    (t) => (
      <div className="pointer-events-auto w-full max-w-md rounded-[var(--radius-panel)] border border-[hsl(var(--border-strong)/0.38)] bg-card/95 bg-[image:var(--gradient-surface)] p-4 shadow-[var(--shadow-raised)] backdrop-blur-[var(--blur-surface)]">
