...
// import {Stake_ContractAddress, Leaf_ContractAddress} from "@/constants/index";

// Fallback contract addresses - update these if you have the actual addresses
const Stake_ContractAddress = "";
const Leaf_ContractAddress = "";

export const stakeContract = {
    address: getAddress(Stake_ContractAddress!),
    abi: 
    [
        {
          "type": "constructor",
...
export const leafContract = {
  address: getAddress(Leaf_ContractAddress!),
  abi: 
  [
  {
    "type": "constructor",
