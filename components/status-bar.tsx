...
export default function StatusBar() {
  ...
  return (
    <div className="w-full bg-background" role="region" aria-label="Account balance and staking">
      <div className="host-chrome-stable-surface host-chrome-solid-card host-chrome-stable-theme rounded-b-2xl border border-border/70 bg-card/95 px-4 py-1.5 shadow-sm backdrop-blur-md">
