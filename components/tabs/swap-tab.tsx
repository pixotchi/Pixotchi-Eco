...
type MarketWindow = 'm5' | 'h1' | 'h6' | 'h24';
type SeedMarketData = {
  cached?: boolean;
  dexId?: string;
  fdv: number | null;
  ...
  pairUrl?: string;
  priceChange: Partial<Record<MarketWindow, number>>;
  priceNative: string | null;
  priceUsd: string | null;
  rewards: number;
  stale?: boolean;
  timestamp: number;
  txns: Partial<Record<MarketWindow, { buys?: number; sells?: number }>>;
  volume: Partial<Record<MarketWindow, number>>;
  volume24h: number;
};
    ...
    return [
      {
        ...
        body: 'LEAF is generated by staking SEED. Rewards accrue over time and can be claimed, giving players who stake, a free way to earn PTS/TOD and access to more features instead of burning their SEED tokens; without turning LEAF into a public-market token.',
        bullets: [
