                      ...
                      {hasActiveFence && (
                        <div className="flex flex-col gap-1">
                          {fenceStatuses.map((fence) => (
                            <div key={`${fence.type}-${fence.effectUntil}`} className="host-chrome-stable-surface host-chrome-solid-background flex items-center gap-1 bg-background/50 backdrop-blur-sm px-2 py-0.5 rounded-full">
