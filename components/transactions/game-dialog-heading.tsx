...
/** Named game heading keeps dismissal clear of the first betting field. Features
...
export function GameDialogHeading({ title, onClose }: { title: string; onClose: () => void }) {
  return <div className="sticky -top-[var(--dialog-padding)] z-20 -mx-[var(--dialog-padding)] -mt-[var(--dialog-padding)] flex shrink-0 items-center justify-between gap-3 border-b border-white/15 bg-black px-3 py-2 text-white">
