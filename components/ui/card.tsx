...
const Card = forwardRef<HTMLDivElement, CardProps>(
  ({ className, density = 'regular', hover = false, padding = 'md', surface = 'default', children, ...props }, ref) => {
    ...
    const surfaceStyles = {
      default: 'border-border/65 bg-card/95 text-card-foreground shadow-[var(--shadow-hairline)]',
      raised: 'border-border/60 bg-card/95 text-card-foreground shadow-[var(--shadow-raised)]',
      ...
      game: 'border-primary/22 bg-card/90 text-card-foreground shadow-[var(--shadow-control)]',
    };
